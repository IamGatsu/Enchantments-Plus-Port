...
public final class CombatEffects {
    ...
    private static void onTargetDamaged(ServerLevel level, LivingEntity user, LivingEntity target,
        ...
        if (arrow) {
            ...
            // FIX (Bugreport: Storm Strike summont keinen Blitz vom Bogen):
            // Storm Strike ist laut Enchantment-JSON eine reine Bogen-
            // Verzauberung (supported_items: #minecraft:enchantable/bow,
            // exclusive_set/bow_special zusammen mit Sniper). Sie stand aber
            // weiter unten im Melee-only-Codepfad, der bei einem Pfeiltreffer
            // durch das "return" oben nie erreicht wird - Storm Strike konnte
            // dadurch nie ausgeloest werden. Gehoert hier zu Sniper in den
            // Arrow-Zweig.
